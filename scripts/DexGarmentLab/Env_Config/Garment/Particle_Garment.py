...
class Particle_Garment:
    def __init__(
        self,world:World, 
        usd_path:str="/workspace/isaaclab/scripts/DexGarmentLab/Assets/Garment/Dress/Long_LongSleeve/DLLS_Dress008_0/DLLS_Dress008_0_obj.usd", 
        ...
        stretch_stiffness:float=1e6, 
        # bend_stiffness:float=100.0, 
        bend_stiffness:float=250.0, 
        # shear_stiffness:float=100.0, 
        shear_stiffness:float=150.0, 
