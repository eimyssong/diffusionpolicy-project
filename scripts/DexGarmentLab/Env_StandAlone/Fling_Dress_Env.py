...
def FlingDress(pos, ori, usd_path, ground_material_usd, data_collection_flag, record_video_flag):
        
    env = FlingDress_Env(pos, ori, usd_path, ground_material_usd, record_video_flag)
    ...
    if record_video_flag and success:
        if not os.path.exists("Data/Fling_Dress/video"):
            os.makedirs("Data/Fling_Dress/video")
        env.env_camera.create_mp4(get_unique_filename("Data/Fling_Dress/video/video", ".mp4"))
...
if __name__=="__main__":
    ...
    FlingDress(pos, ori, usd_path, args.ground_material_usd, args.data_collection_flag, args.record_video_flag)
