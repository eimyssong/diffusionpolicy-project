...
def FoldTrousers(pos, ori, usd_path, ground_material_usd, data_collection_flag, record_video_flag):
    ...
    ####################################################################################################################
    # move away
    lift_points_1 = np.array([-0.6, 0.8, 0.2])
    lift_points_2 = np.array([0.6, 0.8, 0.2])
    ...
    # move away
    lift_points_1 = np.array([-0.6, 0.8, 0.3])
    lift_points_2 = np.array([0.6, 0.8, 0.3])
    ...
    #     target_pos=np.array([manipulation_points[6][0]+0.02, manipulation_points[6][1]+0.02, 0.02]),
    ...
    pick_x = manipulation_points[6][0]
    pick_y = manipulation_points[6][1]

    success = env.bimanual_dex.dexright.dense_step_action(
        target_pos=np.array([pick_x, pick_y, 0.20]),
        target_ori=pick_ori,
        angular_type="quat",
    ...
    print("target:", [pick_x, pick_y, 0.20])
    ...
    length=abs(manipulation_points[6][0]-manipulation_points[7][0])/2


    env.bimanual_dex.dexright.dense_step_action(
        target_pos=np.array([manipulation_points[6][0], manipulation_points[6][1]-length, length+0.03]),
        target_ori=np.array([0.0, 0.0, 0.707, -0.707]),   
        angular_type="quat",                                                                                
    )
    ...
    # catch garment
    env.bimanual_dex.dexright.dense_step_action(
        target_pos=np.array([manipulation_points[7][0], manipulation_points[7][1], 0.2]),
        target_ori=np.array([0.0, 0.0, 0.707, -0.707]),   
        angular_type="quat",                                                                                 
    )    
...
if __name__=="__main__":
    ...
    # usd_path='/workspace/isaaclab/scripts/DexGarmentLab/Assets/Garment/Dress/Short_LongSleeve/DSLS_Dress214/DSLS_Dress214_obj.usd'
    # usd_path='/workspace/isaaclab/scripts/DexGarmentLab/Assets/Garment/Dress/Long_LongSleeve/DLLS_Dress008_0/DLLS_Dress008_0_obj.usd'
    # usd_path='/workspace/isaaclab/scripts/DexGarmentLab/Assets/Garment/Dress/Long_LongSleeve/DLLS_Dress050_1/DLLS_Dress050_1_obj.usd'
    # usd_path='/workspace/isaaclab/scripts/DexGarmentLab/Assets/Garment/Dress/Short_ShortSleeve/DSSS_Dress380/DSSS_Dress380_obj.usd'
    # usd_path='/workspace/isaaclab/scripts/DexGarmentLab/Assets/Garment/Dress/Short_LongSleeve/DSLS_Dress217/DSLS_Dress217_obj.usd'
    # usd_path='/workspace/isaaclab/scripts/DexGarmentLab/Assets/Garment/Dress/Short_LongSleeve/DSLS_dress271/DSLS_dress271_obj.usd'
    usd_path='Assets/Garment/Dress/Short_LongSleeve/DSLS_Dress274/DSLS_Dress274_obj.usd'
