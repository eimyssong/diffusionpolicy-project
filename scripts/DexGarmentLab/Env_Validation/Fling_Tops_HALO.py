...
def FlingTops(pos, ori, usd_path, ground_material_usd, validation_flag, record_video_flag, training_data_num, stage_1_checkpoint_num, stage_2_checkpoint_num, stage_3_checkpoint_num):

    env = FlingTops_Env(pos, ori, usd_path, ground_material_usd, record_video_flag, training_data_num, stage_1_checkpoint_num, stage_2_checkpoint_num, stage_3_checkpoint_num)
    ...
    if record_video_flag:
        if not os.path.exists("Data/Fling_Tops_Validation_HALO/video"):
            os.makedirs("Data/Fling_Tops_Validation_HALO/video")
        env.env_camera.create_mp4(get_unique_filename("Data/Fling_Tops_Validation_HALO/video/video", ".mp4"))
...
if __name__=="__main__":
    ...
    FlingTops(pos, ori, usd_path, args.ground_material_usd, args.validation_flag, args.record_video_flag, args.training_data_num, args.stage_1_checkpoint_num, args.stage_2_checkpoint_num, args.stage_3_checkpoint_num)
