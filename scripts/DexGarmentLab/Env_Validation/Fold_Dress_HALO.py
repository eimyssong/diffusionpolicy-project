...
def FoldDress(pos, ori, usd_path, ground_material_usd, validation_flag, record_video_flag, training_data_num, stage_1_checkpoint_num, stage_2_checkpoint_num, stage_3_checkpoint_num):
    ...
    if record_video_flag:
        if not os.path.exists("Data/Fold_Dress_Validation_HALO/video"):
            os.makedirs("Data/Fold_Dress_Validation_HALO/video")
        env.env_camera.create_mp4(get_unique_filename("Data/Fold_Dress_Validation_HALO/video/video", ".mp4"))
