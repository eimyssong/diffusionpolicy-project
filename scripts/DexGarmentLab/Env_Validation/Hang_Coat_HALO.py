...
class Hang_Coat_Env(BaseEnv):
    def __init__(
        ...
        self.garment = Particle_Garment(
            ...
            usd_path="/workspace/isaaclab/scripts/DexGarmentLab/Assets/Garment/Tops/Collar_Lsleeve_FrontOpen/TCLO_Jacket131/TCLO_Jacket131_obj.usd" if usd_path is None else usd_path,
            friction=25.0,
...
def Hang_Coat_Validation_HALO(pos, ori, usd_path, env_dx, env_dy, ground_material_usd, validation_flag, record_video_flag, training_data_num, stage_1_checkpoint_num, stage_2_checkpoint_num, stage_3_checkpoint_num):
    ...
    save_dir = "/workspace/isaaclab/scripts/DexGarmentLab/Data/Hang_Coat_Validation_HALO/correspondence_vis"
    ...
    if record_video_flag:
        if not os.path.exists("/workspace/isaaclab/scripts/DexGarmentLab/Data/Hang_Coat_Validation_HALO/video"):
            os.makedirs("/workspace/isaaclab/scripts/DexGarmentLab/Data/Hang_Coat_Validation_HALO/video")
        env.env_camera.create_mp4(get_unique_filename("/workspace/isaaclab/scripts/DexGarmentLab/Data/Hang_Coat_Validation_HALO/video/video", ".mp4"))
    ...
    if validation_flag:
        with open("/workspace/isaaclab/scripts/DexGarmentLab/Data/Hang_Coat_Validation_HALO/validation_log.txt", "a") as f:
            f.write(f"result:{success}  usd_path:{env.garment.usd_path}  pos_x:{pos[0]}  pos_y:{pos[1]}  env_dx:{env_dx}  env_dy:{env_dy} \n")
        if not os.path.exists("/workspace/isaaclab/scripts/DexGarmentLab/Data/Hang_Coat_Validation_HALO/final_state_pic"):
            os.makedirs("/workspace/isaaclab/scripts/DexGarmentLab/Data/Hang_Coat_Validation_HALO/final_state_pic")
        env.env_camera.get_rgb_graph(save_or_not=True,save_path=get_unique_filename("/workspace/isaaclab/scripts/DexGarmentLab/Data/Hang_Coat_Validation_HALO/final_state_pic/img",".png"))
