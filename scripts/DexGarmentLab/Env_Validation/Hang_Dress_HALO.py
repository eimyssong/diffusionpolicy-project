...
def HangDress(pos, ori, usd_path, env_dx, env_dy, ground_material_usd, validation_flag, record_video_flag, training_data_num, stage_1_checkpoint_num, stage_2_checkpoint_num, stage_3_checkpoint_num):
    ...
    if record_video_flag:
        if not os.path.exists("Data/Hang_Dress_Validation_HALO/video"):
            os.makedirs("Data/Hang_Dress_Validation_HALO/video")
        env.env_camera.create_mp4(get_unique_filename("Data/Hang_Dress_Validation_HALO/video/video", ".mp4"))
