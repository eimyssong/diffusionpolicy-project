...
from structure_aware_diffusion_policy_garment.common.replay_buffer import ReplayBuffer
from structure_aware_diffusion_policy_garment.common.sampler import (
    SequenceSampler,
    downsample_mask,
    get_val_mask,
)
from structure_aware_diffusion_policy_garment.dataset.base_dataset import BaseDataset
from structure_aware_diffusion_policy_garment.model.common.normalizer import (
    LinearNormalizer,
...
class RobotDataset(BaseDataset):
    def __init__(
        ...
        self.replay_buffer = ReplayBuffer.copy_from_path(
            zarr_path, keys=["state", "action", "garment_point_cloud", "environment_point_cloud", "points_affordance_feature"]
        )
...
if __name__=="__main__":
    dataset = RobotDataset(
        zarr_path="/home/admin02/DexGarmentLab/Model_HALO/SADP_G/data/Hang_Coat_stage_1_10.zarr",
        horizon=24,
        val_ratio=0.02,
    )
    print("ready")
