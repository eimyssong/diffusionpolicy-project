...
import structure_aware_diffusion_policy_garment.common.logger_util as logger_util
import numpy as np
import torch
import tqdm
import wandb
...
class RobotRunner(BaseRunner):
    ...
    def get_action(
        ...
        with torch.no_grad():
            ...
            obs_dict_input["garment_point_cloud"] = obs_dict["garment_point_cloud"].unsqueeze(0)
            obs_dict_input["points_affordance_feature"] = obs_dict["points_affordance_feature"].unsqueeze(0)
