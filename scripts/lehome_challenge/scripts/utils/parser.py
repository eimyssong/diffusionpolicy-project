...
def setup_record_parser(
    ...
    parser.add_argument(
        ...
        type=str,
        default="scripts/lehome_challenge/Assets/objects/Challenge_Garment",
        help="Base path of the garment configuration.",
    )
    parser.add_argument(
        "--particle_cfg_path",
        type=str,
        default="scripts/lehome_challenge/source/lehome/lehome/tasks/bedroom/config_file/particle_garment_cfg.yaml",
    ...
    parser.add_argument(
        "--dataset_root",
        type=str,
        default="scripts/lehome_challenge/Datasets/record",
...
def setup_replay_parser(
    ...
    parser.add_argument(
        "--dataset_root",
        type=str,
        default="scripts/lehome_challenge/Datasets/record/example/record_top_long_release_10/001",
    ...
    parser.add_argument(
        "--ee_urdf_path",
        type=str,
        default="scripts/lehome_challenge/Assets/robots/so101_new_calib.urdf",
...
def setup_eval_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--eval_dataset_path",
        type=str,
        default="scripts/lehome_challenge/Datasets/eval",
