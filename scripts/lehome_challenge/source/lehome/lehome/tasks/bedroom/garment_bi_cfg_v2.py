...
from scripts.lehome_challenge.source.lehome.lehome.assets.robots.lerobot import SO101_FOLLOWER_CFG
...
class GarmentEnvCfg(DirectRLEnvCfg):
    ...
    garment_cfg_base_path: str = "/scripts/lehome_challenge/Assets/objects/Challenge_Garment"
    particle_cfg_path: str = (
        "/scripts/lehome_challenge/source/lehome/lehome/tasks/bedroom/config_file/particle_garment_cfg.yaml"
    )
    # random seed
