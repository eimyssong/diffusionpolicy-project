...
class FrameTransformer(SensorBase):
    ...
    def _initialize_impl(self):
        ...
        # print("Robot valid:", robot.IsValid())

        # print("\n=== CHILDREN under /World/envs/env_0/Robot ===")
        # if robot.IsValid():
        #     for c in robot.GetChildren():
        #         print(" -", c.GetPath())

        # print("\n=== RigidBody prims under Robot ===")
        # if robot.IsValid():
        #     for p in walk(robot):
        #         if UsdPhysics.RigidBodyAPI(p).GetPrim().IsValid():
        #             print("RB:", p.GetPath())
