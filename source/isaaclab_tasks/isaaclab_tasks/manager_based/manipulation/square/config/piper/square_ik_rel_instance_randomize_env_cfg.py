...
from . import square_joint_pos_instance_randomize_env_cfg
...
@configclass
class PiperSquareInstanceRandomizeEnvCfg(
    square_joint_pos_instance_randomize_env_cfg.PiperSquareInstanceRandomizeEnvCfg
):
