...
def squares_stacked(
    ...
    pos_diff_c12 = square.data.root_pos_w - square_hole.data.root_pos_w

    # Compute square position difference in x-y plane
    xy_dist_c12 = torch.norm(pos_diff_c12[:, :2], dim=1)

    # Compute square height difference
    h_dist_c12 = torch.norm(pos_diff_c12[:, 2:], dim=1)

    # Check square positions
